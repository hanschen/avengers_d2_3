...
\begin{figure}[tb]
    ...
    \caption{Number of synthetic XCO2 observations from a hypothetical CO2M satellite in
        (a) summer and
        (b) winter 2021
        that were available for assimilation.
        The XCO2 observations were aggregated from their original resolution (about 2 km $\times$ 2 km)
        to superobs at the atmospheric transport model grid (about 25 km $\times$ 25 km).
    }
    \label{fig:xco2}
\end{figure}
